    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          name: 'gogoboard',
          path: 'gogoboard',
          component: lazyLoading('gogoboard/Gogoboard'),
          default: true
        },
        {
          name: 'raspberry',
          path: 'raspberry',
          component: lazyLoading('raspberry/Raspberry'),
        },
        // {
        //   name: 'program',
        //   path: 'program',
        //   component: lazyLoading('program/Program'),
        //   // component: Program
        // },
        {
          name: 'program-v1',
        ...
        },
        {
          name: 'program',
          path: 'program/:id?',
          component: lazyLoading('program/ProgramAndBlockly'),
          // component: Program
        },
        {
          name: 'program-blockly',
          path: 'program-blockly',
          component: lazyLoading('program/ProgramBlockly'),
          // component: Program
        },
        {
          name: 'profile',
